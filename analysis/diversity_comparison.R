...
df["shannon"] <- diversity(df[,5:209], "shannon")
...
amp_under15 <- df[df$dev_stage == "less than 15 months"
                  & df$method == "amp",]
amp.15.table <- amp_under15[,5:209]
...
mgx_under15 <- df[df$dev_stage == "less than 15 months"
                                & df$method == "mgx",]
mgx.15.table <- mgx_under15[,5:209]
...
amp_15to30 <- df[df$dev_stage == "15 to 30 months"
                & df$method == "amp",]
amp.1530.table <- amp_15to30[,5:209]
...
mgx_15to30 <- df[df$dev_stage == "15 to 30 months"
                 & df$method == "mgx",]
mgx.1530.table <- mgx_15to30[,5:209]
...
amp_over30 <-df[df$dev_stage == "older than 30 months"
                & df$method == "amp",]
amp.over30.table <- amp_over30[,5:209]
...
mgx_over30 <- df[df$dev_stage == "older than 30 months"
                 & df$method == "mgx",]
mgx.over30.table <- mgx_over30[,5:209]
