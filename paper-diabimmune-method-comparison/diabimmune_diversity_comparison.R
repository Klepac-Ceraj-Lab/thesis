...
### convert r-data objects to csv files (to be read into python notebook )

amp_data <- load("~/Documents/thesis/paper-diabimmune-method-comparison/diabimmune_karelia_16s_data.rdata")
amp_data <- as.data.frame(t(data_16s))
write.csv(amp_data,"~/Documents/thesis/paper-diabimmune-method-comparison/diabimmune_amp.csv")


mdata <- load("~/Documents/thesis/paper-diabimmune-method-comparison/DIABIMMUNE_Karelia_metadata.RData")
meta_df <- as.data.frame(t(metadata))
write.csv(meta_df,"~/Documents/thesis/paper-diabimmune-method-comparison/diabimmune_metadata.csv")
